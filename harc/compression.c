...
/* ищем позицию для вставки */
			...
			if (flag == 0) 
/* позиция не найдена - вставить в конец */
...
//сдвиг в начало инпут файла для кодирования

	posInWRTree = pos;
//запоминаем позицию в буфере при записи дерева в файл
